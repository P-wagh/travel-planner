...
<%@ page import= "com.travelplanner.entity.Admin, com.travelplanner.entity.User, com.travelplanner.entity.Trip, com.travelplanner.helper.Massege, jakarta.servlet.http.HttpSession, com.travelplanner.service.UserService, java.util.List" %>
<%
            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/admin/adminTravelPlans">
                                Travel Plans
                            </a>
                        </li>
                        <!-- <li class="nav-item">
                        ...
                        <div class="flex-shrink-0 dropdown mb-2">
                            <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle"
                                ...
                                <img style="object-fit: cover;"
                                    src="<%= request.getContextPath() %>/images/profiles/<%= admin.getAdminPhoto() %>"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="profilePhoto d-flex justify-content-center">
                                    <img src="<%= request.getContextPath() %>/images/profiles/<%= admin.getAdminPhoto() %>"
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%= admin.getAdminId() %> <input type="hidden" name="adminId"
                                                                value="<%= admin.getAdminId() %>" id="">
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" name="adminName" id=""
                                                            value="<%= admin.getAdminName() %>"></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Phone no:</th>
                                                    <td><input type="text" class="form-control" name="adminPhone" id=""
                                                            value="<%= admin.getAdminPhone() %>"></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Email: </th>
                                                    <td><input type="text" name="adminEmail" class="form-control" id=""
                                                            value="<%= admin.getAdminEmail() %>"></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">role: </th>
                                                    <td>
                                                        <%= admin.getRole() %><input type="hidden" name="userRole"
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Starting plance</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%= trip.getSartingPlace() %></td>
                                                    <td><%= trip.getStartDate() %></td>
                                                    <td><%= trip.getEndDate() %></td>
                                                    <td><%= trip.getBudget() %></td>
                                                </tr>
                                                <%     
                                                        i++;                                           		
                                                    }                                                    
