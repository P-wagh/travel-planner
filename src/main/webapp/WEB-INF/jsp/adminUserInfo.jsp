...
<%@ page import= "com.travelplanner.entity.Admin, com.travelplanner.entity.User, com.travelplanner.helper.Massege, jakarta.servlet.http.HttpSession, com.travelplanner.service.UserService, java.util.List" %>
<%
    ...
    List<User> allUser = (List<User>) session.getAttribute("userList");
