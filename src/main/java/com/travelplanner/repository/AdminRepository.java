...
public interface AdminRepository extends CrudRepository<Admin, Integer>{
    ...
    @Query(value = "select admin_email from admin where admin_id = 2", nativeQuery = true)
    public String getAdminEmail();

    @Query(value = "select admin_password from admin where admin_id = 2", nativeQuery = true)
